    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 shadow rounded">
          <h2 className="text-lg font-bold">{isAnnual ? 'Annual Plan' : 'Monthly Plan'}</h2>
          <p className="mt-2">Basic Plan</p>
          <button className="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Subscribe</button>
        </div>
        <div className="bg-white p-4 shadow rounded">
          <h2 className="text-lg font-bold">{isAnnual ? 'Annual Plan' : 'Monthly Plan'}</h2>
          <p className="mt-2">Premium Plan</p>
          <button className="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Subscribe</button>
        </div>
        <div className="bg-white p-4 shadow rounded">
          <h2 className="text-lg font-bold">{isAnnual ? 'Annual Plan' : 'Monthly Plan'}</h2>
          <p className="mt-2">Elite Plan</p>
          <button className="mt-4 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Subscribe</button>
        </div>
      </div>
    </div>
